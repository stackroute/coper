...
class Introduction extends React.Component
{
  ...
  render()
  {
    const styleFunction = (screenClass) => {
          if (screenClass === 'xl') return { fontSize: '20px',
            backgroundImage: `url(${"../images/intro-back.jpg"})`,
            backgroundSize: 'cover', };
          if (screenClass === 'lg') return { fontSize: '20px',
            backgroundImage: `url(${"../images/intro-back.jpg"})`,
            backgroundSize: 'cover', };
          if (screenClass === 'md') return { fontSize: '18px',
            backgroundImage: `url(${"../images/intro-back.jpg"})`,
            backgroundSize: 'cover', };
          if (screenClass === 'sm') return { fontSize: '15px',
            backgroundImage: `url(${"../images/intro-back.jpg"})`,
...
>>>>>>> bf7416c7e2e2b7c18b01b35058be5c0a5f963b30
