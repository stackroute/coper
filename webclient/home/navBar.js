...
class Navbar extends React.Component {
  ...
  fetchNotification()
  {
    ...
    axios.get('http://172.23.238.152:3000/notifications/'+userDetails.user.username)
  ...
  fetchProfilePic(){
    ...
    var userImage="";
    var userDetails=JSON.parse(localStorage.getItem('cognitiveUser'));
    axios.get('http://172.23.238.152:3000/Profiles?'+userDetails.user.username)
    .then(function (response){
  ...
  fetchMenu(){
    ...
    if(userDetails === null)
    {
      ...
      axios({
        ...
        {
          axios.get('http://172.23.238.152:3000/menus?username='+response.data.user.username)
          .then(function (response){
